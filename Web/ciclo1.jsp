  ...
  <body>
	...
	<div class="panel panel-primary">
            <table background-color: rgb="10,80,70">
                ...
                <div>
                    <th><h5 class="text-center">Ciclo 1. Colmenarejo</h5>
                    ...
                    <th><p class="center ">
                        <a href="gestionCatequistas1.jsp" class="btn btn-primary">
                        <span class="glyphicon glyphicon-book"></span> Catequistas ciclo 1</button>    
                        </a> </p></th>
                </div>            
             </table>
            </div>
        <%
          ...
          ResultSet listado = s.executeQuery ("SELECT menor.nombre, tutor, telefono FROM menor WHERE ciclo='1' ");
        %>
        <div class="container">
              <div class="row"></div>
              <div class="row">
	  ...
	  <td>
        <form method="get" action="gestionCatequistas1.jsp">
