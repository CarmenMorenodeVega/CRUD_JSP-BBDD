...
<html>
  <head>
    ...
    <title>Catequistas Colmenarejo ciclo 1</title>
  </head>
  ...
  <body>    
	...
	<div class="panel panel-primary">
           <table background-color: rgb="10,80,70">
               ...
               <th><h5 class="text-center">Catequistas ciclo 1.</h5> 
    ...
    <%  
      ...
      ResultSet listado = s.executeQuery ("SELECT * FROM catequista WHERE ciclo='1'");
    %>
        ...
        <div class="col s10">
          <div class="card">
              <table class="bordered striped centered responsive-table">
                  <thead>  
              <th>Catequista</th><th>telefono</th><th>ciclo 1</th></thead>
              <%
                while (listado.next()) {
                  out.println("<tr><td>");
                  ...
                  %>
              <td>
                    <form method="post" action="ciclo1.jsp">
