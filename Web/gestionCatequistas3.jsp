...
<html>
  <head>
    ...
    <title>Catequistas Colmenerajo ciclo 3</title>
  </head>
	...
	<div class="panel panel-primary">
           <table background-color: rgb="10,80,70">
               <th></th>
                ...
                <th></th>
                <th></th> 
               <th><h5 class="text-center">Catequistas ciclo 3.</h5> 
      ...
      ResultSet listado = s.executeQuery ("SELECT * FROM catequista WHERE ciclo='3'");
    %>
        ...
        <div class="col s10">
          <div class="card">
              <table class="bordered striped centered responsive-table">
                  <thead>  
              <th>Catequista</th><th>telefono</th><th>ciclo 3</th></thead>
              <%
                while (listado.next()) {
                  out.println("<tr><td>");
                  ...
                  <td>
                    <form method="post" action="ciclo3.jsp">
