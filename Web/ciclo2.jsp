  ...
  <body>
	...
	<div class="panel panel-primary">
            <table background-color: rgb="10,80,70">
                ...
                <div>
                    <th><h5 class="text-center">Ciclo 2. Colmenarejo</h5>
                    ...
                    <th><p class="center ">
                        ...
                        <span class="glyphicon glyphicon-book"></span> Catequistas ciclo 2</button>    
                        </a> </p></th>
                </div>            
             </table>
            </div>
        <%
          ...
          ResultSet listado = s.executeQuery ("SELECT menor.nombre, tutor, telefono FROM menor WHERE ciclo='2' ");
        %>
	  ...
	  <td>
        <form method="get" action="gestionCatequistas2.jsp">
